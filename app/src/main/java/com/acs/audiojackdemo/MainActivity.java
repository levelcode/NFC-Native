...
public class MainActivity extends PreferenceActivity {
    ...
    public static final String DEFAULT_IDP = "FF CA 00 00 00";
    public static final String DEFAULT_AUTH = "FF 86 00 00 05 01 00 04 60 00";
    public static final String DEFAULT_READ = "FF B0 00 04 10";

    public boolean auth_flag=false;
    public boolean write_flag=false;
...
//                                            .getCardState(0)));
 ...
 //           mIccCardStatePreference.setSummary("");
   ...
   /*                         mIccCardStatePreference
    ...
    private class OnPiccWriteApduPreferenceChangeListener implements
            Preference.OnPreferenceChangeListener {

        @Override
        public boolean onPreferenceChange(Preference preference, Object newValue) {

            EditTextPreference piccWriteApduPref = (EditTextPreference) preference;
            String piccCommandApduString = (String) newValue;
            ...
            piccCommandApduString = toHexString(mPiccCommandApdu);
            piccWriteApduPref.setText(piccCommandApduString);
            piccWriteApduPref.setSummary(piccCommandApduString);
    ...
    private class OnPiccTransmitPreferenceClickListener implements
        ...
        private class Transmit implements Runnable {
            ...
            public void run() {
                ...
                mResultReady = false;
                auth_flag=false;
                mPiccCommandApdu = toByteArray(DEFAULT_IDP);
    ...
    private class OnPiccReadPreferenceClickListener implements
            Preference.OnPreferenceClickListener {
        private class Transmit implements Runnable {
            ...
            public void run() {
                ...
                mResultReady = false;
                if( !auth_flag) {
                    mPiccCommandApdu = toByteArray(DEFAULT_AUTH);
                    auth_flag=true;
                    if (!mReader.piccTransmit(mPiccTimeout, mPiccCommandApdu)) {
    ...
    private class OnPiccWritePreferenceClickListener implements
            Preference.OnPreferenceClickListener {
        private class Transmit implements Runnable {
            ...
            public void run() {
                ...
                if( !auth_flag) {
                    ...
                    String user_apdu= "FF D6 00 04 10 "+mPiccTextWrite.getText() ;
                    mPiccCommandApdu = toByteArray(user_apdu);
                    auth_flag=true;
                    write_flag=true;
                    if (!mReader.piccTransmit(mPiccTimeout, mPiccCommandApdu)) {
...
//            });
    ...
    private Preference mPiccRead;
    private Preference mPiccWrite;
    private EditTextPreference mPiccTextRead;
    private EditTextPreference mPiccTextWrite;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPiccRead = findPreference("picc_read");
        mPiccWrite = findPreference("picc_write");
        mPiccTextWrite = (EditTextPreference)findPreference("picc_write_command");
...
//                .setOnPreferenceClickListener(new OnIccUpdateCardStatePreferenceClickListener());
        ...
        mPiccCommandApduPreference.setOnPreferenceChangeListener(new OnPiccCommandApduPreferenceChangeListener());


        mPiccTextWrite.setOnPreferenceChangeListener(new OnPiccWriteApduPreferenceChangeListener());
        ...
        mPiccRead.setOnPreferenceClickListener(new OnPiccReadPreferenceClickListener());

        mPiccWrite.setOnPreferenceClickListener(new OnPiccWritePreferenceClickListener());
...
//        mTrack2DiscretionaryDataPreference.setSummary("");
    ...
    private void showVersionInfo() {
        ...
        version = version + " en desarrollo en 2019";
            ...
            if (mPiccResponseApduReady) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        /* Show the PICC response APDU. */
                        if(auth_flag) {
                            mPiccResponseApduPreference.setSummary("autenticated");
                            mPiccCommandApdu = toByteArray(DEFAULT_READ);
                            auth_flag=false;
                            if (!mReader.piccTransmit(mPiccTimeout, mPiccCommandApdu)) {
                                /* Show the request queue error. */
                                showRequestQueueError();
